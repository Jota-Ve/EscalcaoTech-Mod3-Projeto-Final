...
public class DailyTransactionLimitValidator {
	...
	public DailyTransactionLimitValidator(AccountRepository accountRepository, BigDecimal dailyLimit) {
	...
	public void validate(String accountNumber, List<BigDecimal> transactionValues, LocalDate transactionDate) {
		...
		if (totalForDay.compareTo(dailyLimit) > 0) {
			throw new InvalidTransferException("Daily transaction limit exceeded for date: " + transactionDate);
		}
	}
}
